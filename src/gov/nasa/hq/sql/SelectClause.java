...
public class SelectClause extends SQL {
     ...
     * 
     * @param <code>s</code> an array of type <code>String</code>, each of which
     *        is the name of a column to be included in the SELECT statement
     */
    ...
    /**
     * Indicates whether or not the "DISTINCT" keyword should be added to this
     * select clause
     * 
     * @param <code>b</code> a <code>boolean</code>, if <code>true</code> the
     *        "DISTINCT" keyword is added to the clause
     */
     ...
     * 
     * @param <code>item</code> the name of the column
     * @param <code>position</code> the position in the array of items to be
     *        selected at which this item should be added
     */
