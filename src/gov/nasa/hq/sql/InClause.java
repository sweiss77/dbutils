...
/**
 * This class creates a <code>String</code> which can be used to set the value
 * of a SQL "IN" clause. It does not supply the "IN" keyword itself, that should
 * be done by using the symbolic constant <code>SQL.IN</code> as the comparator
 * in a <code>WhereClause</code>
 * 
 * @author Steve Weiss
 */
public class InClause extends SQL {
     ...
     * <code>StringBuffer</code>, if so, single quotes are added around each
     * item in the list
     * 
