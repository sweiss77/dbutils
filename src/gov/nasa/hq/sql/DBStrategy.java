...
/**
 * Abstract class to encapsulate database-specific behavior in this library. Add
 * new concrete classes as necessary when using new databases and include them
 * in the getInstance() method. Implement the specific methods as needed.
 * 
 * @author baltner
 * 
 */
public abstract class DBStrategy {
    ...
    /**
     * By default returns false, but child classes should over-ride and return
     * true if the database requires all columns from the SELECT CLAUSE to be in
     * the GROUP BY clause
     * 
     * @return boolean
     */
